...
const Login = () => {
  ...
  const { loginUser, setUser, googleLogin, facebookLogin, githubLogin } =
      ...
      <div className="flex flex-col lg:flex-row-reverse relative">
        <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 ">
          ...
          >
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  id="email"
                  placeholder="Email"
                  className="w-full px-3 py-2 border rounded-md dark:border-gray-300  focus:dark:border-violet-600"
                />
              </div>
              <div className="space-y-2">
            ...
            <button
              type="submit"
              className="w-full px-8 py-3 bg-orange-500 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50"
            >
              Sign in
            </button>
          </form>
