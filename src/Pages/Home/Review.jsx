...
const Review = () => {
  return (
    <div>
        ...
        <h1 className="text-3xl font-bold mb-5">What Customer Says</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 px-24 mt-5 mb-10 gap-2">
        <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md  border border-gray-300">
